...
class EnhancedDataProcessor:
    ...
    def reduce_dimensions(self, data, n_components=0.95, fit=True, group_name='default'):
        """
    ...
    def create_sequences(self, data, seq_length, target_col=None, target_horizon=1):
        ...
        for i in range(len(data) - seq_length - (target_horizon if target_col is not None else 0) + 1):
